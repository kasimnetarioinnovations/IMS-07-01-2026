      ...
      <div style={{ padding: "20px", backgroundColor: "#FFFF" }}>
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center", justifyContent: "center" }}>
          ...
          <div>
            ...
            <p style={{ fontWeight: 400, fontSize: "14px", fontFamily: '"Inter", sans-serif', lineHeight: "120%", color: "#0E101A", padding: "5px", backgroundColor: "#E5F0FF", borderRadius: "12px", }}>📍Address -
              {supplier?.address ?
