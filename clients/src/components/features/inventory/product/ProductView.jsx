                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  >{lotDetails[lotFieldKeys[index]] || "-"}</div>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >{variant.size === 'XS' ? 'Extra Small (XS)' : variant.size === 'S' ? 'Small (S)' : variant.size === 'M' ? 'Medium (M)' : variant.size === 'L' ? 'Large (L)' : variant.size === 'XL' ? 'Extra Large (XL)' : '-' || "-"}
                        </div>
                      </div>
                    </div>
