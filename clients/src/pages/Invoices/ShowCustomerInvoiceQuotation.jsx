        ...
        <div style={{ height: "calc(100vh - 70px)", overflow: 'auto' }}>
          <div style={{
            ...
            <div
              ...
              <span style={{
                fontSize: "18px", fontWeight: "700", color: "#474951",
                        ...
                        <div style={{
                          ...
                          <div style={{ width: "100%", display: "flex", justifyContent: "space-between", padding: "0px 5px" }}>
                            <div style={{ textAlign: "left" }}>
                              <div><b>Bank:</b> {quotationData.bankDetails?.bankName || "N/A"}</div>
                              <div><b>Branch:</b>  {quotationData.bankDetails?.branch || "N/A"}</div>
                              <div>
                                Account Holder :{" "}
                                <span style={{ color: "black", fontWeight: "600" }}>
                                  {quotationData.bankDetails?.accountHolderName || "N/A"}
                                </span>
                              </div>
                              <div><b>Account No.:</b> {quotationData.bankDetails?.accountNumber || "N/A"}</div>
                              <div><b>IFSC:</b> {quotationData.bankDetails?.ifsc || "N/A"}</div>
                              <div><b>UPI:</b> {quotationData.bankDetails?.upiId || "N/A"}</div>
                            </div>
                          </div> */}
                        </div>
