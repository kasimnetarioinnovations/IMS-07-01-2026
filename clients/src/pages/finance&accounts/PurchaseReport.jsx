                                            ...
                                            >
                                                <span
                                                    style={{
                                                        ...
                                                        padding: "4px 8px",
                                                        background: product.status === "Delivered" ? "#D4F7C7" : product.status === "Pending" ? "#FFF2D5" : "#F7C7C9",
                                                        color: product.status === "Delivered" ? "#379c13ff" : product.status === "Pending" ? "#CF4F00" : "#A80205",
                                                        borderRadius: 36,
                                                        fontSize: 12,
                                                        marginTop: 4,
                                                    }}
                                                >
                                                    {product.status === "Delivered" ? <TiTick /> : product.status === "Pending" ? "!" : "x"} {product.status}
                                                </span>
                                            </td>
                                        </tr>
                                    ))}
